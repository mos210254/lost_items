...
async function edit(id_form) {
    ...
    async function test() {
        ...
        const res = await $fetch(`${BASE_URL}/api/lost-item/status`, {
            method: "PUT",
            body: data,
        });
        Swal.fire({
        ...
        <div class="md:py-[2rem] py-3 px-3 md:px-[3rem]">
            ...
            <div class="grid grid-cols-2 gap-4 md:gap-6">
                ...
                <nuxt-link to="/admin/oficer_edit">
                    ...
                    >
                        <p class="text-2xl font-semibold text-center drop-shadow-md">📋 รายการของหาย</p>
                    </div>
                </nuxt-link>
            </div>
                ...
                <div class="rounded-lg overflow-x-auto hidden md:block">
                    <table class="w-full hidden md:table">
                        ...
                        <tbody>
                            ...
                            >
                                <td class="border-r border-amber-100 p-3 text-left text-[1.2rem]">0{{ item.id }}</td>
                                <td class="border-r border-amber-100 p-3 text-left text-[1.2rem]">
                                    {{ item.category }}
                                </td>
                                <td class="border-r border-amber-100 p-3 text-left w-[200px] text-[1.2rem]">
                                    <img
                                        v-if="item.picture"
