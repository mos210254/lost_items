...
<template>
  <div
    class="relative min-h-screen flex items-center justify-center bg-gray-400 p-4"
  >
    <HamburgerMenu />

    <div
      class="mx-auto w-full max-w-lg bg-white p-6 md:p-8 rounded-xl shadow-lg"
    >
      <h2
        class="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-4 md:mb-6"
      >
        แจ้งพบของหาย
      </h2>
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="mb-4">
          ...
          <input
            ...
            v-model="form.name"
            required
            class="w-full rounded-md border-gray-300 py-2 md:py-3 px-3 md:px-4 text-sm md:text-base !outline-none border-2 transition"
          />
        </div>
        ...
        <div class="mt-4 md:mt-6">
          <button
            ...
            class="cursor-pointer w-full py-3 md:py-4 rounded-lg text-white font-semibold text-lg bg-blue-400 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition"
          >
